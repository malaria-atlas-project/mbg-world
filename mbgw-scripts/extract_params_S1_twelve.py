...
exportPathDistributed_country = '/mnt/distributedoutput_country_ke12/'
exportPathDistributed_perpixel = '/mnt/distributedoutput_perpixel_ke12/'
 
# location for export of combined extractions (after distributed files joined by extract_combineDistribExtractions.py)
exportPathCombined_country = '/mnt/combinedoutput_country_ke12/'
exportPathCombined_perpixel = '/mnt/combinedoutput_perpixel_ke12/'
