...
realisations_path = '/mnt/qrypfpr010708_africa_run_9.10.2008_trial_eight/realizations_mem_100000000_QRYPFPR010708_Africa_Run_9.10.2008_iterations_FILESTARTREL_FILEENDREL.hdf5'
...
exportPathDistributed_country = '/mnt/distributedoutput_country_ke8/'
exportPathDistributed_perpixel = '/mnt/distributedoutput_perpixel_ke8/'
 
# location for export of combined extractions (after distributed files joined by extract_combineDistribExtractions.py)
exportPathCombined_country = '/mnt/combinedoutput_country_ke8/'
exportPathCombined_perpixel = '/mnt/combinedoutput_perpixel_ke8/'
