...
realisations_path = '/mnt/qrypfpr010708_africa_run_9.10.2008_trial_seventeen/realizations_mem_100000000_QRYPFPR010708_Africa_Run_9.10.2008_iterations_FILESTARTREL_FILEENDREL.hdf5'
...
exportPathDistributed_country = '/mnt/distributedoutput_country_s117/'
exportPathDistributed_perpixel = '/mnt/distributedoutput_perpixel_s117/'
 
# location for export of combined extractions (after distributed files joined by extract_combineDistribExtractions.py)
exportPathCombined_country = '/mnt/combinedoutput_country_s117/'
exportPathCombined_perpixel = '/mnt/combinedoutput_perpixel_s117/'
 
# input 1km salb raster of unique spatial IDs
salblim1km_path="/mnt/auxiliary_data/salblim1km-e_y-x+_S1.hdf5"
salb1km_path="/mnt/auxiliary_data/salb1km-e2_y-x+_S1.hdf5"
...
grump1km_path="/mnt/auxiliary_data/gr071km_y-x+_S1.hdf5" 
grump5km_path="/mnt/auxiliary_data/gr075km_y-x+_S1.hdf5"
#gr001km_path="/home/pwg/mbg-world/datafiles/auxiliary_data/gr001km_ken.hdf5"
 
# location of 5km hdf5  limits mask
lim5kmbnry_path="/mnt/auxiliary_data/st_mask5km-e_y-x+_S1.hdf5"
...
uniqueSalb_path='/mnt/examineSalb/uniqueSalb_s1.txt'
uniqueSalbwholecountries_path='/mnt/examineSalb/uniqueSalbwholecountries_s1.txt'
pixelN_path='/mnt/examineSalb/pixelN_s1.txt'
pixelNwholecountries_path='/mnt/examineSalb/pixelNwholecountries_s1.txt'
