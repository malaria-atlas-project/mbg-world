...
STDOUTPATH = '/home/pwg/mbg-world/extraction/CombinedOutputSTDOUTERR/'
...
CMDS = ['"cd mbg-world/mbgw-scripts/;python ECRUNSCRIPT_combineDistribExtractions.py True True True"'] 
