...
realisations_path = '/mnt/qrypfpr230708_asia_run_1.9.2008_as1/realizations_mem_100000000_QRYPFPR230708_Asia_Run_1.9.2008_iterations_FILESTARTREL_FILEENDREL.hdf5'
...
exportPathDistributed_country = '/mnt/distributedoutput_country_as1/'
exportPathDistributed_perpixel = '/mnt/distributedoutput_perpixel_as1/'
 
# location for export of combined extractions (after distributed files joined by extract_combineDistribExtractions.py)
exportPathCombined_country = '/mnt/combinedoutput_country_as1/'
exportPathCombined_perpixel = '/mnt/combinedoutput_perpixel_as1/'
